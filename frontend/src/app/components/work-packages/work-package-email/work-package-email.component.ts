...
@Component({
  selector: 'work-package-email',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './work-package-email.component.html'
})
export class WorkPackageEmailComponent extends WorkPackageCommentFieldHandler implements OnInit, OnDestroy {
  ...
  public text = {
    newEmail: this.I18n.t('js.label_new_email'),
  };

  public inFlight = false;
  public canAddEmail:boolean;
